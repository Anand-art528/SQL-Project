...
BULK INSERT city
FROM 'C:\Users\Brij\Downloads\archive\city.csv'
    WITH
	(
	    FIRSTROW=2,
		FIELDTERMINATOR=',',
	...
	FROM 'C:\Users\Brij\Downloads\archive\products.csv'
	    WITH
		(
		FIRSTROW=2,
		FIELDTERMINATOR=',',
	...
	FROM 'C:\Users\Brij\Downloads\archive\customers.csv'
	    WITH
		(
		FIRSTROW=2,
		FIELDTERMINATOR=',',
    ...
    SET DATEFORMAT dmy
	BULK INSERT sales
	FROM 'C:\Users\Brij\Downloads\archive\sales.csv'
	    WITH
		(
		FIRSTROW=2,
		FIELDTERMINATOR=',',
...
--The business wants to know recent performance. Decisions should be based on current momentum, escpecially before expansion.
...
---------------------------------------------------------------------------------------------------
--8. Find each city and their average sale pe customer and avg rent per customer.
...
--🔍 Business Problem
--How much we earn from each customer and how much cost (rent) is involved per customer
